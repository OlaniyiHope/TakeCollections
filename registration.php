      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="login_form_inner">
            <h3>Sign Up to use</h3>
            <form class="row login_form" action="regscript.php" method="post">
              <div class="col-md-12 form-group">
                <input type="text" class="form-control"  name="txtrole" placeholder="Role">
              </div>
              <div class="col-md-12 form-group">
                ...
                <div class="col-md-12 form-group">
                <input type="text" class="form-control"  name="emmail" placeholder="Email Address">
              </div>
                <div class="col-md-12 form-group">
              ...
              <div class="col-md-12 form-group">
                <div class="creat_account">
                  ...
                  <label for="f-option2">Keep me Sign up</label>
                </div>
              </div>
              <div class="col-md-12 form-group">
