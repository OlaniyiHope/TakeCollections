...
<body>
	...
	<!--================Single Product Area =================-->
		...
		<div class="container d-flex rer">
						...
						if (isset($_GET['tid'])) {
							...
							$result = mysqli_query($con,"SELECT  `image` FROM post WHERE postId = '$tid'");                                                      
							while($row = mysqli_fetch_array($result)) {
					...
					<div class="s_product_text">
						...
						if (isset($_GET['tid'])) {
							...
							$result = mysqli_query($con,"SELECT  `title`, `price`, `content` FROM post WHERE postId = '$tid'");                                                      
							while($row = mysqli_fetch_array($result)) {
